...
| initialValidatorSet                        | List                | Optional | List of initial validator set.                                                                                                                                                     |
| initialValidatorSet[i].publicKey           | string              |          | PublicKey of the initial validator.                                                                                                                                                |
| initialValidatorSet[i].power               | long                |          | Power of the initial validator.                                                                                                                                                    |
