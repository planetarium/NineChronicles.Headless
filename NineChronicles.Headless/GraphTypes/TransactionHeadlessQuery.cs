        ...
        public TransactionHeadlessQuery(StandaloneContext standaloneContext)
        {
            ...
            Field<ListGraphType<TransactionType>>(
                ...
                arguments: new QueryArguments(
                    ...
                    { Name = "onlySuccess", Description = "filter tx is succeeded." }
                ),
                resolve: context =>
                {
                    ...
                    var onlySuccess = context.GetArgument<bool>("onlySuccess");
                    ...
                    var transactions = blocks
                        ...
                        .Where(tx => tx.Actions.Any(rawAction =>
                        {
                            ...
                            if(onlySuccess)
                            {
                                ...
                                if (txResult is not null && txResult.TxStatus != TxStatus.SUCCESS)
                                {
                                    return false;
                                }
                            }
